...
num_rows = 50000  # Change the number of rows as needed
num_cols = 200  # Change the number of columns as needed
...
def generate_excel_file(num_rows, num_cols):
    ...
    data_types = [
        "Boolean", "Number", "Percent", "Integer", "List", "Date", "DateTime", "Text", "Text", "Text"
    ]
    ...
    for col in range(num_cols):
        ...
        for row in range(num_rows):
            if data_type == "Boolean":
                ...
                data_value = random.uniform(1, 1000)
